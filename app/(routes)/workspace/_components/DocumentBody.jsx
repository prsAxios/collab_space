    ...
    return (
        <div>
            ...
            <CoverPicker setNewCover={(cover) => {
                ...
                <div className='relative group cursor-pointer'>
                    ...
                    <div className='group-hover:opacity-40'>
                        <Image className='w-full h-[200px] object-cover rounded-t-xl' 
                            src={coverImage} 
                            width={500} 
                            height={500} 
                            alt='cover image' 
            ...
            <div className='absolute ml-10 mt-[-25px] cursor-pointer'>
                <EmojiPickerComponent setEmojiIcon={(value) => {
                    setEmojiIcon(value);
                    updateDocumentInfo("emoji", value);
                }}>
                    <div>
                        {emojiIcon ? <span className='text-5xl'>{emojiIcon}</span> : <SmilePlus className='h-10 w-10 text-green-300'/> }
                    </div>
